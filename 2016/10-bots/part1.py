...
def find_target_bot(values, bot_instructions, target_bot_values):
    ...
    while full_bots:
        ...
        target_bot = [b for b in full_bots if sorted(bot_values[b]) == target_bot_values]
        if target_bot:
            return target_bot[0]
        for b in full_bots:
...
print(find_target_bot(values, bot_instructions, [17, 61]))
